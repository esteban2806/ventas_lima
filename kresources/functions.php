...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail">
        <a target="_blank" href="item.php?id={$row['product_id']}" ><img width ='100' src="../kresources/{$product_photo}" alt=""></a>
            <div class="caption">
                <h4 class="pull-right">S/.{$row['product_price']}</h4>
               <h4> <a target="_blank" href="item.php?id={$row['product_id']}" >{$row['product_title']}</a></h4>
                 <p>{$row['product_description']}.</p>
                 </div> <a class="btn btn-primary" target="_blank" href="..\kresources\cart.php?add={$row['product_id']}" text-align:center>Añadir</a> </div>
 </div>
DELIMETER;
        echo $products;
    }
 ...
 <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>{$row['short_desc'] }</p>
                        <p>
                            <a href="..\kresources\cart.php?add={$row['product_id']}" class="btn btn-primary">Comprar ahora!</a> <a href="item.php?id={$row['product_id']}" class="btn btn-default">More Info</a>
                        </p>
                    </div>
                </div>
            </div>
 ...
 <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>{$row['short_desc'] }</p>
                        <p>
                            <a href="..\kresources\cart.php?add={$row['product_id']}" class="btn btn-primary">Comprar</a>
                            <a href="item.php?id={$row['product_id']}" class="btn btn-default">Más Info</a>
                        </p>
                    </div>
                </div>
            </div>
